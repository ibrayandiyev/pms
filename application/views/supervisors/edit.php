		...
		<div class="col-md-12 col-lg-4 col-xl-3">
			<div class="image-content-center user-pro">
				<div class="preview">
					...
					<img src="<?=get_image_url('supervisor', $supervisor['photo'])?>">
				</div>
			</div>
		</div>
		...
		<div class="panel-heading">
			<h4 class="panel-title">
				...
				<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#profile">
					<i class="fas fa-user-edit"></i> Supervisor Details
				</a>
			</h4>
		</div>
		<div id="profile" class="accordion-body">
			<?php echo form_open_multipart($this->uri->uri_string()); ?>
			<input type="hidden" name="supervisor_id" value="<?php echo $supervisor['id']; ?>" id="supervisor_id">
                        ...
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    autocomplete="off" value="<?=set_value('joining_date', $supervisor['joining_date'])?>" />
                                </div>
...
<div id="authentication_modal" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
	<section class="panel">
		...
		<?php echo form_open('supervisors/change_password', array('class' => 'frm-submit')); ?>
        <div class="panel-body">
...
<script type="text/javascript">
	var authenStatus = "<?=$supervisor['active']?>";
</script>
