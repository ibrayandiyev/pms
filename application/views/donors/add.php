		...
		<section class="panel">
			...
			<header class="panel-heading">
				<h4 class="panel-title">
					<i class="far fa-user-circle"></i> Add Donor
				</h4>
			</header>
					...
					<div class="col-md-4 mb-sm">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" name="phone" value="<?=set_value('phone')?>" autocomplete="off" />
							</div>
				...
				<div class="row">
                    <div class="col-md-5 mb-sm">
                        <div class="form-group">
                            ...
                            <textarea name="description" rows="2" class="form-control" aria-required="true"><?=set_value('description')?></textarea>
                    ...
                    <div class="col-md-4 mb-sm">
						<div class="form-group">
							...
							<?php
								...
								echo form_dropdown("country_name", $countryNameList, "", "class='form-control' id='country_name'
